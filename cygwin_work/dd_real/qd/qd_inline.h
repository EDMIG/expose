...
inline qd_real::qd_real(long int i) {
	x[0] = static_cast<double>(i);
	x[1] = x[2] = x[3] = 0.0;
}

inline qd_real::qd_real(long unsigned int i) {
	x[0] = static_cast<double>(i);
	x[1] = x[2] = x[3] = 0.0;
}
...
inline qd_real &qd_real::operator=(long int i) {
	x[0] = static_cast<double>(i);
	x[1] = x[2] = x[3] = 0.0;
	return *this;
}

inline qd_real &qd_real::operator=(long unsigned int i) {
	x[0] = static_cast<double>(i);
	x[1] = x[2] = x[3] = 0.0;
	return *this;
}
