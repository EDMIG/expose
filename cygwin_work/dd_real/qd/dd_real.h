...
public:
    ...
    inline static dd_real max() {
        return dd_real::_max;
    }
    inline static dd_real safe_max() {
...
QD_API inline bool isnan(const dd_real &a) {
    return a.isnan();
}
QD_API inline bool isfinite(const dd_real &a) {
    return a.isfinite();
}
QD_API inline bool isinf(const dd_real &a) {
    return a.isinf();
}
...
/*
��Ҫ����T��std::complex<dd_real>��ʽ
template<typename T>
QD_API dd_real operator+(const dd_real &a, T b)
{
	return operator+(a, double(b));
}

template<typename T>
QD_API dd_real operator+(T b, const dd_real &a)
{
	return operator+(a, double(b));
}
...
template<typename T>
QD_API bool operator!=(const dd_real &a, T b)
{
	return operator!=(a, double(b));
}
...
/*
for Eigen Custom Type defination:
*/
inline const dd_real& conj(const dd_real& x) {
    return x;
}
inline const dd_real& real(const dd_real& x) {
    return x;
}
inline dd_real imag(const dd_real&) {
    return 0.;
}
inline dd_real abs2(const dd_real& x) {
    return sqr(x);
}
