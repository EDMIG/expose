...
struct QD_API qd_real {
    ...
    qd_real &operator=(long int i);
    qd_real &operator=(long unsigned int i);
...
QD_API inline bool isnan(const qd_real &a) {
    return a.isnan();
}
QD_API inline bool isfinite(const qd_real &a) {
    return a.isfinite();
}
QD_API inline bool isinf(const qd_real &a) {
    return a.isinf();
}
